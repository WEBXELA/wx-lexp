...
export default function Contact() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-b from-gray-50 to-white font-inter"
    >
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">lexp@webxela.com</p>
                  </div>
                </motion.div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4 ">
                  <motion.a
                    ...
                    aria-label="LinkedIn"
                  >
                    <Linkedin className="w-5 h-5 text-gray-900 hover:text-primary-600" />
                  </motion.a>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-primary-600 text-white rounded-lg px-4 py-2 font-semibold hover:bg-primary-700 transition-colors"
              >
                Send Message
              </motion.button>
            </form>
