...
export default function Contact() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 font-inter"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            <GradientText
              colors={['#0066FF', "#3385FF", '#69AFFF', "#3385FF", '#0066FF']}
              animationSpeed={8}
              showBorder={false}
            >
          ...
          >
            <div className="p-8">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-primary-50 dark:bg-gray-700 flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex space-x-4 ">
                  {[
                    ...
                    >
                      <social.icon className="w-5 h-5 text-gray-900 hover:text-primary-600" />
                    </motion.a>
                  ))}
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors resize-none"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors shadow-lg hover:shadow-primary-500/20"
              >
