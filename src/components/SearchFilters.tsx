  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={onSearch}
        disabled={isLoading}
        className="mt-4 sm:mt-6 w-full bg-purple-600 text-white py-2 sm:py-3 px-4 sm:px-6 rounded-lg text-sm sm:text-base font-medium flex items-center justify-center space-x-2 hover:bg-purple-700 transition-colors disabled:opacity-50"
      >
