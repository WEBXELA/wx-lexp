  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <div className="space-y-1 sm:space-y-2">
          ...
          <input
            ...
            className="w-full px-3 sm:px-4 py-1.5 sm:py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
      ...
      <motion.button
        ...
        onClick={onSearch}
        disabled={isLoading}
        className="mt-4 sm:mt-6 w-full bg-primary-600 text-white py-2 sm:py-3 px-4 sm:px-6 rounded-lg text-sm sm:text-base font-medium flex items-center justify-center space-x-2 hover:bg-primary-700 transition-colors disabled:opacity-50"
      >
